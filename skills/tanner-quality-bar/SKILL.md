...
here. Whether you're reviewing a *diff* before it merges ([[tanner-code-review]]) or auditing
a *live URL* as a cold visitor ([[tanner-website-review]]), you judge the page against the same
...
- **Follow the voice.** Any user-facing text — prose, headings, titles, labels, metadata —
  follows the [[tanner-brand-voice]] skill: the voice, tone, and hard grammatical rules (no
