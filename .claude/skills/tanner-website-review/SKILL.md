...
**This is not `tanner-code-review` (`.claude/skills/tanner-code-review/SKILL.md`).** That skill reviews a *diff* before it merges, mapping
...
actually good." Any copy you'd rewrite still routes through `tanner-brand-voice` (`.claude/skills/tanner-brand-voice/SKILL.md`).
...
live in `tanner-quality-bar` (`.claude/skills/tanner-quality-bar/SKILL.md`) — judge every page against that bar first. It defines the
